...
schedulers = [
    ...
    Scheduler('cosine-exponential blend', 'Cosine-exponential Blend', cosexpblend_scheduler, need_inner_model=True),
    Scheduler('phi', 'Phi', phi_scheduler, need_inner_model=True),
    Scheduler('laplace', 'Laplace', get_sigmas_laplace, need_inner_model=True),
    Scheduler('karras dynamic', 'Karras Dynamic', get_sigmas_karras_dynamic, need_inner_model=True),
