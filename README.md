...
After checking the code itself when trying to develeop new features on reForge, I can say for sure it uses most of the ComfyUI backend to do the heavy work. So, all credits to comfyanonymous and lllyasviel for their work! Without them, forge could have not been possible.
