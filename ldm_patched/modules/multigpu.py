...
def create_multigpu_deepclones(model: ModelPatcher, max_gpus: int, gpu_options: GPUOptionsGroup=None, reuse_loaded=False):
    ...
    extra_devices = ldm_patched.modules.model_management.get_all_torch_devices(exclude_current=True)
    ...
    if len(extra_devices) > 0:
        for device in extra_devices:
            ...
            if reuse_loaded:
                ...
                loaded_models: list[ModelPatcher] = ldm_patched.modules.model_management.loaded_models()
