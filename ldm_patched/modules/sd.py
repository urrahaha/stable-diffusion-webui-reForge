    ...
    if len(clip_data) == 1:
        if "text_model.encoder.layers.30.mlp.fc1.weight" in clip_data[0]:
            ...
            if w is not None and w.shape[0] == 248:
                clip_target.clip = ldm_patched.modules.text_encoders.long_clipl.LongClipModel
                clip_target.tokenizer = ldm_patched.modules.text_encoders.long_clipl.LongClipTokenizer
            else:
