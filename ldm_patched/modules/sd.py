...
def load_text_encoder_state_dicts(state_dicts=[], embedding_directory=None, clip_type=CLIPType.STABLE_DIFFUSION, model_options={}):
    ...
    if len(clip_data) == 1:
        ...
        if clip_type == CLIPType.SD3:
            ...
            clip_target.clip = ldm_patched.modules.text_encoders.sd3_clip.sd3_clip(clip_l=TEModel.CLIP_L in te_models, clip_g=TEModel.CLIP_G in te_models, t5=TEModel.T5_XXL in te_models)
            clip_target.tokenizer = ldm_patched.modules.text_encoders.sd3_clip.SD3Tokenizer
