...
def _calc_cond_batch_multigpu(model: BaseModel, conds: list[list[dict]], x_in: torch.Tensor, timestep: torch.Tensor, model_options: dict[str]):
    ...
    device_batched_hooked_to_run: dict[torch.device, list[tuple[ldm_patched.hooks.HookGroup, tuple]]] = {}
    ...
    def _handle_batch(device: torch.device, batch_tuple: tuple[ldm_patched.hooks.HookGroup, tuple], results: list[thread_result]):
...
class CFGGuider:
    ...
    def outer_sample(self, noise, latent_image, sampler, sigmas, denoise_mask=None, callback=None, disable_pbar=False, seed=None):
        ...
        multigpu_patchers = ldm_patched.modules.sampler_helpers.prepare_model_patcher_multigpu_clones(self.model_patcher, self.loaded_models, self.model_options)
