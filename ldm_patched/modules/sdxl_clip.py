...
class SDXLTokenizer:
    def __init__(self, embedding_directory=None, tokenizer_data={}):
        ...
        self.clip_l = clip_l_tokenizer_class(embedding_directory=embedding_directory, tokenizer_data=tokenizer_data)
...
class SDXLClipModel(torch.nn.Module):
    def __init__(self, device="cpu", dtype=None, model_options={}):
        ...
        self.clip_l = clip_l_class(layer="hidden", layer_idx=-2, device=device, dtype=dtype, 
...
class StableCascadeClipGTokenizer(sd1_clip.SDTokenizer):
    def __init__(self, tokenizer_path=None, embedding_directory=None, tokenizer_data={}):
        super().__init__(tokenizer_path, pad_with_end=True, embedding_directory=embedding_directory, 
                        embedding_size=1280, embedding_key='clip_g', tokenizer_data=tokenizer_data)

class StableCascadeTokenizer(sd1_clip.SD1Tokenizer):
    def __init__(self, embedding_directory=None, tokenizer_data={}):
        super().__init__(embedding_directory=embedding_directory, tokenizer_data=tokenizer_data, 
                         clip_name="g", tokenizer=StableCascadeClipGTokenizer)
...
class StableCascadeClipG(sd1_clip.SDClipModel):
    def __init__(self, device="cpu", max_length=77, freeze=True, layer="hidden", layer_idx=-1, dtype=None, model_options={}):
        ...
        super().__init__(device=device, freeze=freeze, layer=layer, layer_idx=layer_idx, textmodel_json_config=textmodel_json_config, dtype=dtype,
                         ...
                         enable_attention_masks=True, return_projected_pooled=True, model_options=model_options)
