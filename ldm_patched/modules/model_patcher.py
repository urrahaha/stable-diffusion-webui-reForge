...
class ModelPatcher:
    ...
    def deepclone_multigpu(self, new_load_device=None, models_cache: dict[uuid.UUID,ModelPatcher]=None):
        ...
        ldm_patched.modules.model_management.unload_model_and_clones(self)
        n = self.clone()
    ...
    def match_multigpu_clones(self):
        ...
        if len(multigpu_models) > 0:
            ...
            for mm in multigpu_models:
                ...
                n.remove_additional_models("multigpu")
                orig_additional_models: dict[str, list[ModelPatcher]] = ldm_patched.modules.patcher_extension.copy_nested_dicts(n.additional_models)
                n.additional_models = ldm_patched.modules.patcher_extension.copy_nested_dicts(mm.additional_models)
    ...
    def _handle_changed_hook_keyframes(self, kf_changed_cache: list[ldm_patched.hooks.Hook]):
